...
module.exports = function createBaseConfig(context, isServer) {
  ...
  const evergreen =
    typeof siteConfig.evergreen === 'function' ? siteConfig.evergreen() : siteConfig.evergreen;
  if (!evergreen) {
  ...
  function createCSSRule(lang, test, loader, options) {
    ...
    function applyLoaders(rule, modules) {
      ...
      rule
        ...
        .options({ plugins: [require('autoprefixer')], sourceMap: !isProd, ...siteConfig.postcss });
  ...
  createCSSRule('sass', /\.sass$/, 'sass-loader', { indentedSyntax: true, ...siteConfig.sass });
