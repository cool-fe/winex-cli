 ...
 */
async function checkExist(filePath: string, askForOverWrite = false): Promise<boolean> {
 ...
 */
function syncModifyFile(filePath: string, pattern: RegExp, replace: string, encoding = 'utf8') {
  let fileContent;
  try {
    //@ts-ignore
